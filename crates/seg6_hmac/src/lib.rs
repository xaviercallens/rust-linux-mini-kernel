...
#[no_mangle]
pub unsafe extern "C" fn seg6_hmac_cmpfn(
    arg: *mut c_void,
    obj: *const c_void,
) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn seg6_hinfo_release(
...
#[no_mangle]
pub unsafe extern "C" fn seg6_free_hi(
    ptr: *mut c_void,
    _arg: *mut c_void,
) {
...
#[no_mangle]
pub unsafe extern "C" fn seg6_get_tlv_hmac(
...
#[no_mangle]
pub unsafe extern "C" fn __hmac_get_algo(
    alg_id: u8,
) -> *mut seg6_hmac_algo {
...
pub unsafe extern "C" fn seg6_hmac_compute(
    ...
    *off = (*hdr).flags;
    ...
    let dgsize = __do_hmac(hinfo, ring as *const c_void, plen as u8, tmp_out.as_mut_ptr(), tmp_out.len() as c_int);
    if dgsize < 0 {
        return dgsize;
    }
    
    let wrsize = if dgsize < SEG6_HMAC_FIELD_LEN { dgsize } else { SEG6_HMAC_FIELD_LEN };
...
#[no_mangle]
pub unsafe extern "C" fn seg6_hmac_validate_skb(
    skb: *mut c_void,
) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn seg6_hmac_info_lookup(
    net: *mut c_void,
    key: u32,
) -> *mut seg6_hmac_info {
...
#[no_mangle]
pub unsafe extern "C" fn seg6_hmac_info_del(
    net: *mut c_void,
    key: u32,
) -> c_int {
    let sdata = seg6_pernet(net);
...
#[no_mangle]
pub unsafe extern "C" fn seg6_hmac_net_init(
    net: *mut c_void,
) -> c_int {
    let sdata = seg6_pernet(net);
...
#[no_mangle]
pub unsafe extern "C" fn seg6_hmac_net_exit(
    net: *mut c_void,
) {
    let sdata = seg6_pernet(net);
...
extern "C" {
    ...
    fn crypto_shash_digest(desc: *mut c_void, data: *const c_void, len: size_t, out: *mut u8) -> c_int;
    ...
    fn rhashtable_lookup_fast(table: *mut c_void, key: *mut c_void, params: rhashtable_params) -> *mut c_void;
    fn rhashtable_lookup_insert_fast(table: *mut c_void, node: *mut c_void, params: rhashtable_params) -> c_int;
    fn rhashtable_remove_fast(table: *mut c_void, node: *mut c_void, params: rhashtable_params) -> c_int;
    fn rhashtable_init(table: *mut c_void, params: rhashtable_params) -> c_int;
    fn rhashtable_free_and_destroy(table: *mut c_void, free_fn: extern "C" fn(*mut c_void, *mut c_void), arg: *mut c_void);
}
